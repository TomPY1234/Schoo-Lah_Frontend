                      ...
                      Padding(
                        ...
                        child: RichText(
                          text: TextSpan(children: [
                            ...
                            TextSpan(text: 'E-Books', style: TextStyle(
                              fontFamily: "pop",
                              fontWeight: FontWeight.w700,
                              fontSize: 25,
                              color: Colors.orange,
                            ...
                            children: <Widget>[
                              Flexible(
                                ...
                                child: Container(
                                  ...
                                  child: Image.asset('${ebook.image}', height: 130),
                                  decoration: BoxDecoration(
                                  ...
                                  child: Column(
                                    ...
                                    children: <Widget>[
                                      Padding(
                                        ...
                                        child: Text('${ebook.title}\n\nPrice : \nRM ${ebook.price.toStringAsFixed(2)}', style: TextStyle(
                                          fontFamily: "pop",
                                          fontWeight: FontWeight.w700,
                                          fontSize: 20,
                                          color: Colors.white)
