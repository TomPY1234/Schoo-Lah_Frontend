                      ...
                      Padding(
                        ...
                        child: RichText(
                          text: TextSpan(children: [
                            TextSpan(text: 'Successfully ', style: TextStyle(
                              fontFamily: "pop",
                              fontWeight: FontWeight.w700,
                              fontSize: 25,
                              color: Colors.black,
                            ...
                            TextSpan(text: 'Registered', style: TextStyle(
                              fontFamily: "pop",
                              fontWeight: FontWeight.w700,
                              fontSize: 25,
                              color: Colors.orange,
                                ...
                                child: Container(
                                  ...
                                  child: Align(
                                    ...
                                    child: Column(
                                      ...
                                      children: <Widget>[
                                        Image.asset('assets/MATHEMATICS.png', height: 100),
                                        ...
                                        Text('Sun 31 Jan 2021', style: TextStyle(
                                          fontFamily: "pop",
                                          fontWeight: FontWeight.w700,
                                          fontSize: 19,
                                          color: Colors.white)
