                                    ...
                                    children: <Widget>[
                                      ...
                                      Padding(
                                        ...
                                        child: FloatingActionButton.extended(
                                          ...
                                          label: Text('Login Now', style: TextStyle(
                                            fontFamily: "pop",
                                            fontWeight: FontWeight.w700,
                                            fontSize: 20,
                                            color: Colors.white,
                                      ...
                                      Padding(
                                        padding: EdgeInsets.only(left: 10, right: 10, top: 30),
                                        child: TextButton(
                                          child: Text('First Time User? Sign Up Now!', style: TextStyle(
                                            fontFamily: "pop",
                                            fontWeight: FontWeight.w700,
                                            fontSize: 15,
                                            color: Colors.white,
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          content: SingleChildScrollView(
            child: ListBody(
              children: <Widget>[
                Text('Please enter a valid username and password.', style: TextStyle(
                  fontFamily: "pop",
                  fontWeight: FontWeight.w700,
                  fontSize: 18,
                  color: Colors.black,
